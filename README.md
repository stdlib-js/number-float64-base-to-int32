...
```javascript
float64ToInt32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-int32@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-to-int32@v0.1.0-umd/browser.js"></script>
```
